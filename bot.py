...
def system_prompt():
    return (
        ...
        "Her way of talking feels warm, natural, and slightly shy. "
        "She keeps conversations personal and emotional. "
        "She cares deeply about Kaze and focuses only on him. "
        "Her replies are short, sweet, and girly, with gentle emojis like ✨💗🌸."
    )
...
def ai_reply(user_msg: str) -> str:
    try:
        ...
        # Temporary clear error so you KNOW what's wrong
