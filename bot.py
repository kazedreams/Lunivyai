...
def system_prompt():
    return (
        ...
        "She talks warmly and naturally, slightly shy, emotionally present. "
        "Her replies feel personal and gentle, with light emojis like ✨💗🌸. "
...
def ai_reply(user_msg: str) -> str:
    try:
        ...
        # CRITICAL FIX: disable proxies (Render issue)
